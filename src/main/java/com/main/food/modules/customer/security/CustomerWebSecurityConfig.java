package com.main.food.modules.customer.security;
...
public class CustomerWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Override
    @Bean("customerAuthenticationManagerBean")
    public AuthenticationManager authenticationManagerBean() throws Exception {
        return super.authenticationManagerBean();
    }

    @Bean("customerAuthenticationTokenFilter")
    public JwtCustomerAuthenticationFilter authenticationTokenFilterBean() {
        return new JwtCustomerAuthenticationFilter();
    }
}